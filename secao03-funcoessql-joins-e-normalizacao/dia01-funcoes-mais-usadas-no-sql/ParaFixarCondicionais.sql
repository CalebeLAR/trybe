...
SELECT 
	film_id, title,
    IF(title = 'ACE GOLDFINGER', 'Já assisti', 'não assistí') AS 'conheço o filme?'
FROM sakila.film;


-- Usando o CASE na tabela sakila.film, exiba o título, a classificação indicativa (rating) 
-- e uma coluna extra que vamos chamar de ‘público-alvo’ em que colocaremos a classificação do 
-- filme de acordo com as seguintes siglas:
-- G: “Livre para todos”;
