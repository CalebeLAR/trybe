...
# para fixar exercício 01
def test_analyze_json_file_invalid_extension_path_exception():
    fake_file_path = "invalid_extension_path.com"
    match = "O arquivo precisa ser um arquivo JSON."
