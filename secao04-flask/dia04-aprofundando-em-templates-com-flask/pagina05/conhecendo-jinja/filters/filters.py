...
loader = FileSystemLoader('secao04-flask/dia04-aprofundando-em-templates-com-flask/pagina05/conhecendo-jinja/filters')
# conhecendo-jinja/filters/filters.html
