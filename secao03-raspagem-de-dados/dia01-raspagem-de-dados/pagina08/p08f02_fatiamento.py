...
print("01234567"[3:6])  # Saída: "avra"

# Começando do elemento de índice 1, vá até o último,
# saltando de 2 em 2
print([1, 2, 3, 4][1::2])  # Saída: [2, 4]
print([i for i in range(0, 16)][1:10:1])  # Saída: [2, 4]
print([i for i in range(0, 16)][1:12:2])  # Saída: [2, 4]
print([i for i in range(0, 16)][1:16:4])  # Saída: [2, 4]
